...
- Keep documentation that's useful for human developers in `ReadMe.md` files and reference them in `AGENTS.md`, unless doing so would negatively impact performance
