...
" General colors
hi Normal
    \ guifg=#f6f3e8         guibg=black         gui=NONE
    \ ctermfg=NONE          ctermbg=NONE        cterm=NONE
hi NonText
    \ guifg=#070707         guibg=black         gui=NONE
    \ ctermfg=black         ctermbg=NONE        cterm=NONE

hi Cursor
    \ guifg=black           guibg=white         gui=NONE
    \ ctermfg=black         ctermbg=white       cterm=reverse
hi LineNr
    \ guifg=#3D3D3D         guibg=black         gui=NONE
    \ ctermfg=darkgray      ctermbg=NONE        cterm=NONE

hi VertSplit
    \ guifg=#202020         guibg=#202020       gui=NONE
    \ ctermfg=darkgray      ctermbg=darkgray    cterm=NONE
hi StatusLine
    \ guifg=#CCCCCC         guibg=#202020       gui=italic
    \ ctermfg=white         ctermbg=darkgray    cterm=NONE
hi StatusLineNC
    \ guifg=black           guibg=#202020       gui=NONE
    \ ctermfg=blue          ctermbg=darkgray    cterm=NONE

hi Folded
    \ guifg=#a0a8b0         guibg=#384048       gui=NONE
    \ ctermfg=NONE          ctermbg=NONE        cterm=NONE
hi Title
...
hi SpecialKey
    \ guifg=#808080         guibg=#343434       gui=NONE
    \ ctermfg=NONE          ctermbg=NONE        cterm=NONE

hi WildMenu
    \ guifg=green           guibg=yellow        gui=NONE
    \ ctermfg=black         ctermbg=yellow      cterm=NONE
hi PmenuSbar
    \ guifg=black           guibg=white         gui=NONE
    \ ctermfg=black         ctermbg=white       cterm=NONE
"hi Ignore
"   \ guifg=gray            guibg=black         gui=NONE
"   \ ctermfg=NONE          ctermbg=NONE        cterm=NONE

hi Error
    \ guifg=NONE            guibg=NONE          gui=undercurl
    \ ctermfg=white         ctermbg=red         cterm=NONE
    \ guisp=#FF6C60 " undercurl color
hi ErrorMsg
    \ guifg=white           guibg=#FF6C60       gui=BOLD
    \ ctermfg=white         ctermbg=red         cterm=NONE
hi WarningMsg
    \ guifg=white           guibg=#FF6C60       gui=BOLD
    \ ctermfg=white         ctermbg=red         cterm=NONE
hi LongLineWarning
    \ guifg=NONE            guibg=#371F1C       gui=underline
    \ ctermfg=NONE          ctermbg=NONE	    cterm=underline

" Message displayed in lower left, such as --INSERT--
hi ModeMsg
    \ guifg=black           guibg=#C6C5FE       gui=BOLD
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi CursorColumn
    ...
    \ ctermfg=NONE          ctermbg=NONE        cterm=BOLD
  hi MatchParen
    \ guifg=#f6f3e8         guibg=#857b6f       gui=BOLD
    \ ctermfg=white         ctermbg=darkgray    cterm=NONE
  hi Pmenu
    \ guifg=#f6f3e8         guibg=#444444       gui=NONE
    \ ctermfg=NONE          ctermbg=NONE        cterm=NONE
  hi PmenuSel
    \ guifg=#000000         guibg=#cae682       gui=NONE
    \ ctermfg=NONE          ctermbg=NONE        cterm=NONE
  hi Search
    \ guifg=NONE            guibg=#2F2F00       gui=underline
    \ ctermfg=NONE          ctermbg=NONE	    cterm=underline
endif
...
" Special for Ruby
hi rubyRegexp
    \ guifg=#B18A3D         guibg=NONE          gui=NONE
    \ ctermfg=brown         ctermbg=NONE        cterm=NONE
hi rubyRegexpDelimiter
    \ guifg=#FF8000         guibg=NONE          gui=NONE
    \ ctermfg=brown         ctermbg=NONE        cterm=NONE
hi rubyEscape
    \ guifg=white           guibg=NONE          gui=NONE
    \ ctermfg=cyan          ctermbg=NONE        cterm=NONE
...
hi rubyStringDelimiter
    \ guifg=#336633         guibg=NONE          gui=NONE
...
hi javaDocSeeTag
    \ guifg=#CCCCCC         guibg=NONE          gui=NONE
    \ ctermfg=darkgray      ctermbg=NONE        cterm=NONE
hi javaDocSeeTag
    \ guifg=#CCCCCC         guibg=NONE          gui=NONE
    \ ctermfg=darkgray      ctermbg=NONE        cterm=NONE
"hi javaClassDecl
"   \ guifg=#CCFFCC         guibg=NONE          gui=NONE
"   \ ctermfg=white         ctermbg=NONE        cterm=NONE
